...
<head>
    ...
    <title>Unaviva B2B - Narudžba</title>

    <meta name="title" content="Unaviva B2B - Narudžba">
    ...
    <meta property="og:title" content="Unaviva B2B - Narudžba">
    ...
    <meta property="twitter:title" content="Unaviva B2B - Narudžba">
...
<body>
    ...
    $query = $db->prepare("
        SELECT t1.client_name, t1.client_business_type, t1.client_code, t1.client_id_number, t1.client_pdv_number, t2.order_id, t2.order_status, t2.created_at, t2.order_total_price, t2.order_total_tax, t2.order_total_rabat, t2.order_to_pay, t2.employee_id
        FROM idk_client t1
        INNER JOIN idk_order t2
        ON t1.client_id = t2.client_id
        WHERE t2.order_id = :order_id AND t2.order_key = :order_key");
    ...
    $order_created_at = $client['created_at'];
    $order_status = $client['order_status'];
    $order_total_price = $client['order_total_price'];
    $order_total_tax = $client['order_total_tax'];
    $order_total_rabat = $client['order_total_rabat'];
    $order_to_pay = $client['order_to_pay'];
    ...
    ?>
        ...
        <div id="print_header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-6">
                        <h3>Narudžba #<?php echo $order_id; ?></h3>
                        <p class="idk_margin_top30">
                            ...
                            <?php } ?>
                            <br>
                            <strong>Datum narudžbe:</strong> <br>
                            <?php echo date('d.m.Y.', strtotime($order_created_at)); ?> <br>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td width="15%" class="text-right tg-sfdd"><?php echo number_format($product_price, 3, ',', '.'); ?></td>
                                    <td width="15%" class="text-right tg-sfdd">
                                    ...
                                    <td width="20%" class="text-right tg-nj7c"><?php echo number_format($product_total_price, 3, ',', '.'); ?></td>
                                </tr>
                            ...
                            <tr>
                                ...
                                <th class="text-right tg-nj7c"><?php echo number_format($order_total_rabat, 3, ',', '.'); ?> KM</th>
                            </tr>
                            <tr>
                                <th colspan="4" class="text-right tg-ofj5">Iznos bez PDV-a</th>
                                <th class="text-right tg-nj7c"><?php echo number_format($order_total_price, 3, ',', '.'); ?> KM</th>
                            </tr>
                            <tr>
                                <th colspan="4" class="text-right tg-ofj5">PDV 17%</th>
                                <th class="text-right tg-nj7c"><?php echo number_format($order_total_tax, 3, ',', '.'); ?> KM</th>
                            </tr>
                            <tr>
                                <th colspan="4" class="text-right tg-ofj5">Ukupno</th>
                                <th class="text-right tg-nj7c"><?php echo number_format($order_to_pay, 2, ',', '.'); ?> KM</th>
                            </tr>
                        </tbody>
                    </table>
