	...
	<div class="container">
		<div class="row">
			...
			?>
				...
				<!-- Import csv button trigger modal -->
				<div class="col-xs-12 idk_margin_top10 idk_margin_bottom30">
					<a href="#" class="btn material-btn material-btn-icon-success material-btn_success main-container__column material-btn-icon-responsive" data-toggle="modal" data-target="#importCsvModal"><i class="fa fa-file" aria-hidden="true"></i> <span>&nbsp;&nbsp;CSV IMPORT</span></a>
				</div>

				<!-- Modal import csv -->
				<div class="modal material-modal material-modal_primary fade text-left" id="importCsvModal">
					<div class="modal-dialog ">
						<div class="modal-content material-modal__content">
							<div class="modal-header material-modal__header">
								<button class="close material-modal__close" data-dismiss="modal">&times;</button>
								<h4 class="modal-title material-modal__title">Import CSV datoteke</h4>
							</div>
							<div class="modal-body material-modal__body">

								<!-- Form - import csv -->
								<form action="<?php getSiteUrl(); ?>idkadmin/do.php?form=import_csv_clients" method="post" role="form" class="form-horizontal" enctype="multipart/form-data" id="idk_import_csv_form">

									<!-- Add csv file -->
									<div class="form-group">
										<label for="csv_file" class="col-sm-4 control-label"><span class="text-danger">*</span> CSV datoteka:</label>
										<div class="col-sm-8">
											<div class="fileinput fileinput-new" data-provides="fileinput">
												...
												<div>
													...
													<i class="fa fa-info-circle fa-lg idk_margin_left10" data-toggle="tooltip" data-placement="right" title="Napomena: Dokument ne smije biti veći od 20MB! - Dozvoljeni format: CSV" aria-hidden="true"></i>
													<br>
							...
							<div class="modal-footer material-modal__footer">
								...
								<script>
									$(function() {
										$('#idk_import_csv_form').submit(function() {
